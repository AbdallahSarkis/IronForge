...
<div class="page" id="page-admin-members">
        <div class="section-header">
          ...
          <div class="section-sub">Member management</div>
        </div>
        <div class="panel">
          <table class="table">
            <thead><tr><th>Member</th><th>Email</th><th>Plan</th><th>Status</th><th>Actions</th></tr></thead>
            <tbody>
              <tr>
                <td><div style="display:flex;align-items:center;gap:12px;"><div style="width:36px;height:36px;border-radius:50%;background:linear-gradient(135deg,#22c55e,#16a34a);display:flex;align-items:center;justify-content:center;font-weight:700;font-size:0.8rem;">JD</div><div><div style="font-weight:600;">John Doe</div></div></div></td>
                <td style="color:var(--muted);">john@example.com</td>
                <td><span class="badge badge-accent">Premium</span></td>
                <td><span class="badge badge-green">Active</span></td>
                <td><button class="btn btn-sm btn-danger"><i class="fas fa-ban"></i> Suspend</button></td>
              </tr>
            </tbody>
          </table>
        </div>
