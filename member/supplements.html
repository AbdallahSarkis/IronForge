...
<nav class="sidebar" id="sidebar">
  ...
  <div class="main" id="main">
    <div class="topbar">
      <div class="topbar-title" id="topbar-title">Shop</div>
...
<div class="page" id="page-member-supplements">
        <div class="section-header">
          <div class="section-title">Supplements & Equipment</div>
          <div class="section-sub">Browse and order from our store</div>
        </div>
