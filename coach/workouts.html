...
<nav class="sidebar" id="sidebar">
  ...
  <div class="main" id="main">
    <div class="topbar">
      <div class="topbar-title" id="topbar-title">Workouts</div>
...
<div class="page" id="page-coach-workouts">
        <div class="section-header">
          ...
          <div class="section-sub">Create and manage workout plans</div>
        </div>
        <div class="grid-2">
          <div class="panel">
            <div class="panel-header"><div class="panel-title">Create New Plan</div></div>
            <div class="panel-body">
              <div class="field">
                <label class="field-label">Workout Name</label>
                <input class="input" id="new-workout-name" placeholder="e.g. Upper Body Strength">
              </div>
              <div class="field">
              ...
              <div class="field">
                <label class="field-label">Exercises (one per line)</label>
                <textarea class="textarea" id="new-workout-exercises" placeholder="Bench Press 4x8&#10;Pull-ups 3x10&#10;Shoulder Press 3x12"></textarea>
              </div>
              <button class="btn btn-primary" onclick="createWorkout()"><i class="fas fa-paper-plane"></i> Assign Workout</button>
            </div>
          </div>
          <div class="panel">
            <div class="panel-header"><div class="panel-title">Assigned Workouts</div></div>
            <div id="coach-assigned-workouts" style="padding:1rem;"></div>
          </div>
        </div>
      </div>
    </div>
