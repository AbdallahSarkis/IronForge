...
<nav class="sidebar" id="sidebar">
  ...
  <div class="main" id="main">
    <div class="topbar">
      <div class="topbar-title" id="topbar-title">Near Coaches</div>
...
<div class="page" id="page-user-near-coaches">
        <div class="section-header">
          <div class="section-title">Coaches Near You</div>
          <div class="section-sub">Explore coach profiles and choose who fits your goals.</div>
        </div>
        <div class="grid-3" id="coaches-grid"></div>
      </div>
    </div>
  </div>
</div>
...
<!-- Coach Contact Modal -->
<div class="modal-overlay" id="coach-contact-modal">
  <div class="modal-box">
    <div class="modal-header">
      <div class="modal-title" id="coach-contact-modal-title">Contact Coach</div>
      <button class="modal-close" onclick="closeModal('coach-contact-modal')"><i class="fas fa-times"></i></button>
    </div>
    <div class="modal-body" id="coach-contact-modal-body"></div>
  </div>
</div>
