...
<nav class="sidebar" id="sidebar">
  ...
  <div class="main" id="main">
    <div class="topbar">
      <div class="topbar-title" id="topbar-title">Coaches</div>
...
<div class="page" id="page-admin-coaches">
        <div class="section-header">
          ...
          <div class="section-sub">Staff management</div>
        </div>
        <div class="panel">
          <table class="table">
            <thead><tr><th>Coach</th><th>Email</th><th>Clients</th><th>Status</th></tr></thead>
            <tbody>
              <tr>
                <td><div style="display:flex;align-items:center;gap:12px;"><div style="width:36px;height:36px;border-radius:50%;background:linear-gradient(135deg,var(--blue),var(--purple));display:flex;align-items:center;justify-content:center;font-weight:700;font-size:0.8rem;">SJ</div><div><div style="font-weight:600;">Sarah Johnson</div></div></div></td>
                <td style="color:var(--muted);">sarah@example.com</td>
                <td>2</td>
