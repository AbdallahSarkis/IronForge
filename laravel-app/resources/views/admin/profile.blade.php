...
<div id="app">
  ...
  <div class="main" id="main">
    ...
    <div class="page-content">
      <div class="page" id="page-admin-profile">
        <div class="section-header">
          <div class="section-title">Gym Profile</div>
          <div class="section-sub">Manage gym identity, hours, and location.</div>
        </div>

        <div class="panel" style="max-width:720px;">
          <div class="panel-body">
            <form id="profile-form" method="POST" action="/admin/profile/update">
              @csrf
              ...
              <div class="form-group">
                ...
                <input type="text" class="form-control" name="gym_name" id="profile-gym-name" placeholder="IRONFORGE Downtown">
              </div>

              <div style="display:grid;grid-template-columns:1fr 1fr;gap:10px;">
                <div class="form-group">
                  <label class="form-label">Open Time</label>
                  <input type="time" class="form-control" name="gym_open_time" id="profile-gym-open-time">
                </div>
                <div class="form-group">
                  <label class="form-label">Close Time</label>
                  <input type="time" class="form-control" name="gym_close_time" id="profile-gym-close-time">
                </div>
              </div>
              ...
              <div class="form-group">
                ...
                <input type="text" class="form-control" name="location_address" id="profile-location-address" placeholder="Search gym location or click on map">
              ...
              <div class="form-group">
                ...
                <div style="margin-top:8px;color:var(--muted);font-size:0.82rem;">Tip: Click on the map to pin your exact gym location.</div>
              </div>
              ...
              <div style="display:flex;gap:10px;margin-top:20px;">
                ...
                <button type="button" class="btn btn-secondary" onclick="switchPage('admin-dashboard')" style="flex:1;">
...
document.addEventListener('DOMContentLoaded', async function() {
  try {
    ...
    if (response.ok) {
      ...
      document.getElementById('profile-gym-name').value = user.gym_name || '';
      document.getElementById('profile-gym-open-time').value = user.gym_open_time || '';
      document.getElementById('profile-gym-close-time').value = user.gym_close_time || '';
